...
/**
 * The lockdown window gets its own bridge, deliberately smaller than the setup
 * window's. Notably it has no file picker — during a session there should be
 * no route to browsing the disk, not even an unused one.
 */
